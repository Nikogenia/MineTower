...
class Docker:
    ...
    def __init__(self, main, prefix, network_name, network_subnet):
        ...
        try:
            ...
            self.logger.error("Failed to connect to docker socket!")
            self.logger.error("Please mount the docker socket!")
